...
> 状态：设计草案 + M1–M5 最小基座已实现（M4.5 Editor Orchestration、M5 React Shell）。本页作为对应主题的维护入口。
...
_附：上层交互行为规范请参见 [产品交互体验设计规范 (Product Experience Specification)](product-experience-spec.md)。_
