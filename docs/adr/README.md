...
| [ADR-009](009-release-governance.md)                | 发布与治理策略（M6 预备 / M7 首次发布）       | Accepted | 2026-07-05 |
| [ADR-010](010-block-stable-identity.md)             | 顶层块稳定 `id` 与 Block Focus 坐标           | Accepted | 2026-07-06 |
