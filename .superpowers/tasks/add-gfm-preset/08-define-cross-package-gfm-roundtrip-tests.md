...
- 2026-07-05: Post-review fix — updated list matrix cases to edit an adjacent paragraph while preserving list output, avoiding a no-op `replaceText` target.
- 2026-07-05: Validation — `pnpm --filter @aether-md/preset-gfm test` 12/12 pass; `pnpm check` pass.
