...
- 2026-07-05: Post-review fix — added recursive inline conversion for nested link/mark combinations and made `replaceText` fail closed on non-text blocks instead of returning ok for a no-op.
- 2026-07-05: Validation — `pnpm --filter @aether-md/plugin-prosemirror test` 16/16 pass; `pnpm check` pass.
